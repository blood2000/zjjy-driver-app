...
export default {
    ...
    pickedArr() {
      ...
      if (this.isInitMultiArray) {
        const obj = {
          ...
          2: () => {
            return [CHINA_REGIONS, CHINA_REGIONS[0].childs];
          },
          3: () => {
            return [
              CHINA_REGIONS,
  ...
  methods: {
    ...
    handleValueChange(e) {
      ...
      let address = [arr0[index0], arr1&&arr1[index1], arr2&&arr2[index2]];
             address = address.filter((item)=> item !==undefined )

       console.log('getRegion',address);
